...
export const scrapeMP4 = async({ id }) => {
    ...
    try {
        ...
        return {
          err: err,
          "Referer": "https://gotaku1.com/streaming.php?id=NTAwODA=&title=Future+Card+Buddyfight++Episode+60&typesub=DUB",
          "sources": [
          {
          "file": "https://ta-011.abecdn..60.1677667164.m3u8",
          "label": "auto P",
          "type": "hls"
          }
          ],
          "sources_bk": [
          {
          "file": "https://www011.anifastcdn.info/videos/hls/4FL25Ok0ciSgWUMLOZqacA/1685975302/50080/915625cb7d313f5907d61b5701676446/ep.60.1677667164.m3u8",
          "label": "hls P",
          "type": "hls"
          }
          ]
...
export const scrapeRecentRelease = async({ list = [], page = 1, type = 1 }) => {
    try {
        ...
        $('div.last_episodes.loaddub > ul > li').each((i, el) => {
            const animeTitle = $(el).find('p.name > a').attr('title').trim()
            const animeId =  $(el).find('p.name > a').attr('href').split('/')[1].split('-episode-')[0]
            const episodeId = $(el).find('p.name > a').attr('href').split('/')[1]
            ...
            list.push({
                ...
                subOrDub: $(el).find('div > a > div').attr('class').replace('type ic-', '').trim(),
                animeImg: $(el).find('div > a > img').attr('src').trim(),
                episodeUrl: BASE_URL + '/' + $(el).find('p.name > a').attr('href').trim(),
            });
        });
        return list;
    } catch (err) {
